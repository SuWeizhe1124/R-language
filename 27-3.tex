...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/inline-plot-knitr-1} 
...
\includegraphics[width=.75\linewidth]{figure/figure-plot-1} \caption[Simple plot of the numbers 1 through 10]{Simple plot of the numbers 1 through 10.}\label{fig:figure-plot}
\end{figure}
